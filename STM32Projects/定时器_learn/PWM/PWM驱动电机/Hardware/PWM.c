...
void PWM_Init(void)
{
	...
	TIM_InitBaseStructure.TIM_Period = 20000-1;						// ARR
	TIM_InitBaseStructure.TIM_Prescaler = 72-1;					// PSC
	...
	TIM_OCIInitStructure.TIM_Pulse = 0;								// CCR
	TIM_OC2Init(TIM2,&TIM_OCIInitStructure);
